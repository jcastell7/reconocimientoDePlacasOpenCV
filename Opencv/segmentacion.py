...
A=cv2.imread("C:\Users\juan\My Documents\LiClipse Workspace\placas\image\procesado2.jpg")
[fil,col,cap]=A.shape
...
for i in range(0,fil):
    for j in range(0,col):
        ...
        K[i,j]=1-MAX
cv2.imwrite("C:\Users\juan\My Documents\LiClipse Workspace\placas\image\prueba.bmp",K)
k=cv2.imread("C:\Users\juan\My Documents\LiClipse Workspace\placas\image\prueba.bmp")
